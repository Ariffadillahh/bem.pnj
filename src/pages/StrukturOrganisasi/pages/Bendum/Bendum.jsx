...
import logoBendum from "../../../../assets/images/kemas/logo-kemas.png";
import fotoBendum from "../../../../assets/images/kemas/kabid.png";

const Bendum = () => {
  const bendumData = {
    id: "bendum",
    namaBidang: "Biro Bendahara Umum",
    tahun: "BEM PNJ 2026",
    tagline: "Transparansi dan Akuntabilitas Finansial",
    deskripsiUtama:
      "Bertanggung jawab dalam pengelolaan sirkulasi keuangan, penyusunan anggaran, serta pengawasan dana usaha guna mendukung stabilitas finansial organisasi BEM PNJ 2026.",
    logo: logoBendum,
    fotoKabid: fotoBendum,
    agenda: [
      {
        nama: "Pengelolaan Iuran Fungsionaris",
        deskripsi:
          "Manajemen pengumpulan dan pendataan iuran rutin fungsionaris BEM PNJ untuk kebutuhan operasional internal.",
      },
      {
        nama: "Laporan Keuangan Bulanan",
        deskripsi:
          "Penyusunan dan publikasi transparansi penggunaan anggaran organisasi secara berkala setiap bulannya.",
      },
      {
        nama: "Audit Keuangan Program Kerja",
        deskripsi:
          "Melakukan pemeriksaan laporan pertanggungjawaban keuangan dari setiap kegiatan yang dilaksanakan oleh bidang/departemen.",
      },
    ],
  };
    ...
    <section className="py-12 md:py-20 bg-white min-h-screen">
      <div className="max-w-6xl mx-auto px-5">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 mb-16 md:mb-20">
          {/* TEKS & DESKRIPSI (Atas di Mobile, Kiri di Laptop) */}
        ...
        <div className="w-full">
          <ContentSlider
            items={bendumData.agenda}
            title="Daftar Agenda Bendahara Umum"
          />
        </div>
      </div>
    </section>
